    ...
    >
      ...
      <div className="absolute top-0 left-0 z-10 flex flex-col items-start p-[clamp(1rem,5vw,3rem)] w-full max-w-3xl">
        <motion.h2
          ...
          viewport={{ once: true }}
          className="font-poppins text-[clamp(1.5rem,3vw,2.5rem)] font-bold text-[#0B5345] mb-4 drop-shadow-lg"
        >
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="font-poppins text-2xl md:text-3xl text-black mb-6 font-semibold"
        >
        ...
        <motion.a
          ...
          viewport={{ once: true }}
          className="font-poppins mt-2 inline-flex items-center button-text text-[#0B5345] text-lg border-b border-[#0B5345] border border-black pb-1 hover:border-b-2 hover:pb-[2px] transition-all bg-white/80 rounded-none px-6 py-2 font-semibold shadow-lg group"
        >
